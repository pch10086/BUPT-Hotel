    ...
    def parse_operation(self, value: str, room_num: int) -> Optional[TestOperation]:
        ...
        if value == "开机":
            return TestOperation(
                ...
                target_temp=(23.0 if self.mode == "HEAT" else 25.0),  # 根据测试模式选择缺省温度
...
def load_test_case_from_text():
    ...
    test_data = [
        ...
        ["15", "", "", "", "", "20, 高"],  # 时间15分钟：房间5设20℃高风
        ["16", "", "关机", "", "", ""],  # 时间16分钟：房间2关机
        ["17", "", "", "高", "", ""],  # 时间17分钟：房间3设高风
        ["18", "开机", "", "", "20, 中", ""],  # 时间18分钟：房间1开机，房间4设20℃中风
        ["19", "", "开机", "", "", ""],  # 时间19分钟：房间2开机
        ["20", "", "", "", "", "25"],  # 时间20分钟：房间5设25℃
        ["21", "", "", "", "", ""],  # 时间21分钟：无操作
        ["22", "", "", "关机", "", ""],  # 时间22分钟：房间3关机
...
def load_test_case_heat():
    ...
    test_data = [
        ...
        ["4", "", "", "28", "", "高"],  # 时间4分钟：房间3设28℃，房间5设高风
        ["5", "高", "", "", "", ""],  # 时间5分钟：房间1设高风
        ["6", "", "", "", "", ""],  # 时间6分钟：无操作
        ["7", "", "", "", "", "24"],  # 时间7分钟：房间5设24℃
        ["8", "", "", "", "", ""],  # 时间8分钟：无操作
        ["9", "22", "", "", "21, 高", ""],  # 时间9分钟：房间1设22℃，房间4设21℃高风
        ["10", "", "", "", "", ""],  # 时间10分钟：无操作
        ["11", "", "", "", "", "中"],  # 时间11分钟：房间5设中风
        ["12", "", "高", "", "", ""],  # 时间12分钟：房间2设高风
        ["13", "", "", "", "", ""],  # 时间13分钟：无操作
        ...
        ["19", "", "", "", "", ""],  # 时间19分钟：无操作
        ["20", "", "26, 中", "", "", "开机"],  # 时间20分钟：房间2设26℃中风，房间5开机
        ["21", "", "", "", "", ""],  # 时间21分钟：无操作
        ["22", "", "", "", "", ""],  # 时间22分钟：无操作
        ["23", "", "", "", "", ""],  # 时间23分钟：无操作
